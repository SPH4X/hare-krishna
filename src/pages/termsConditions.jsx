...
function termsConditions() {
  return (
    <div className="bg-black text-white py-10 px-10">
      <Head>
        <title className="text-6xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">Terms and Conditions</title>
      </Head>
      <h1 className="heading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">Terms and Conditions</h1>
      <p>
        This website is operated by Hare Krishna Mandir, Jodhpur. Throughout the
        site, the terms “we”, “us” and “our” refer to Hare Krishna Mandir,
        Jodhpur or HKM, Jodhpur. Hare Krishna Mandir, Jodhpur offers this
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 1 – ONLINE STORE TERMS</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 2 – GENERAL CONDITIONS</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 5 – PRODUCTS OR SERVICES</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 7 – OPTIONAL TOOLS</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 8 – THIRD-PARTY LINKS</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 10 – PERSONAL INFORMATION</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 12 – PROHIBITED USES</h2>
      <p>
      ...
      <p>
        In no case shall International Society of Krishna Consciousness, our
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 14 – INDEMNIFICATION</h2>
      <p>
        You agree to indemnify, defend and hold harmless International Society
        of Krishna Consciousness and our parent, subsidiaries, affiliates,
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 15 – SEVERABILITY</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 16 – TERMINATION</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 17 – ENTIRE AGREEMENT</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 18 – GOVERNING LAW</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 19 – CHANGES TO TERMS OF SERVICE</h2>
      <p>
      ...
      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 20 – CONTACT INFORMATION</h2>
      <p>
        Questions about the Terms of Service should be sent to us at
        info@hkmjodhpur.org.
      </p>

      <h2 className="subheading text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">Refund / Cancellation Policy</h2>
      <p>
        Transactions which are successfully debited by the payment gateway but
        not confirmed back to Hare Krishna Mandir, Jodhpur System will be deemed
        to be a failure transaction. All such transactions are eligible for
        refund post reconciliation. Such transactions will be refunded in 10-15
        working days.
      </p>
      <p>All donations are final. Cancellation is not allowed.</p>
      <p>All comments & issues should be discussed at info@hkmjodhpur.org</p>
    </div>
  );
}
