...
const privacyPolicy = () => {
  return (
    <>
      {" "}
      <div className="bg-black text-white py-7 px-7">
  ...
  Privacy Policy
        ...
        <br />
        <h2  className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">
          {" "}
        ...
        <p>
          ...
          as your name, address and email address. <br />
          ...
          system. <br /> Email marketing (if applicable): With your permission,
          we may send you emails about our store, new products and other
          updates.
        </p>
        <br />
        <h2 className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black"> SECTION 2 – CONSENT</h2> <br />
        <p>
          How do you get my consent? <br /> When you provide us with personal
          ...
          only. <br /> If we ask for your personal information for a secondary
          ...
          <br /> How do I withdraw my consent? <br /> If after you opt-in, you
          change your mind, you may withdraw your consent for us to contact you,
          for the continued collection, use or disclosure of your information,
          at anytime, by contacting us at info@hkmjodhpur.org or mailing us at:
          Hare Krishna Mandir, Mukundra Vihar (NH-27), Jodhpur, Rajasthan -
          324007.
        </p>{" "}
        <br />
        <h2 className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 3 – DISCLOSURE</h2> <br />
        <p>
          We may disclose your personal information if we are required by law to
          do so or if you violate our Terms of Service.
        </p>{" "}
        <br />
        <h2 className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 4 – PAYMENT</h2> <br />
        <p>
          ...
          complete, your purchase transaction information is not saved. <br />{" "}
          ...
          information by our store and its service providers. <br /> For more
        ...
        <p>
          ...
          them to perform the services they provide to us. <br /> However,
          ...
          <br /> In particular, remember that certain providers may be located
          ...
          Policy or our website’s Terms of Service. <br />
        ...
        <br />
        <h2 className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 6 – SECURITY</h2> <br />
        <p>
        ...
        <br />
        <h2 className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 7 – COOKIES</h2> <br />
        <p>
          We use cookies to maintain session of your user. It is not used to
          personally identify you on other websites.
        </p>{" "}
        <br />
        <h2 className="text-2xl font-extrabold tracking-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-black">SECTION 8 – AGE OF CONSENT</h2> <br />
        <p>
        ...
        <p>
          ...
          info@hkmjodhpur.org or by mail at Hare Krishna Mandir, Mukundra Vihar
          (NH-27), Jodhpur, Rajasthan - 324007.
        </p>{" "}
        <br />
      </div>
    </>
