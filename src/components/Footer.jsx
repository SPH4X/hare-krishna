...
export default function Footer() {
  return (
    <>
      <footer
        className="font-medium gap-5 w-full text-white bg-black"
        id="footer"
      >
        <div className="flex gap-2 justify-evenly flex-wrap max-w-7xl mx-auto px-4 py-12">
          <div className="flex flex-col my-8 lg:my-0 sm:flex-row lg:flex-col gap-4">
            ...
            >
              <Image
                ...
                className="object-contain p-2" // Tailwind classes for control
                width={300}
                height={150}
              />
            </Link>
            <div className="space-y-4 text-center max-w-xs">
              <p className="">
                Hare Krishna Road, Behind ITC Welcome Road Soder Ki Dhani,
                Nandra, Rajasthan 342015
              </p>
  ...
  target="_blank"
  className="rounded-xl bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-600 hover:via-pink-500 hover:to-yellow-400 text-white duration-150 transition-all h-8 w-8"
>
  <svg
    stroke="currentColor"
    fill="white"
  ...
  >
    ...
    <path d="M20.533 6.111A4.605 4.605 0 0 0 17.9 3.479a6.606 6.606 0 0 0-2.186-.42c-.963-.042-1.268-.054-3.71-.054s-2.755 0-3.71.054a6.554 6.554 0 0 0-2.184.42 4.6 4.6 0 0 0-2.633 2.632 6.585 6.585 0 0 0-.419 2.186c-.043.962-.056 1.267-.056 3.71 0 2.442 0 2.753.056 3.71.015.748.156 1.486.419 2.187a4.61 4.61 0 0 0 2.634 2.632 6.584 6.584 0 0 0 2.185.45c.963.042 1.268.055 3.71.055s2.755 0 3.71-.055a6.615 6.615 0 0 0 2.186-.419 4.613 4.613 0 0 0 2.633-2.633c.263-.7.404-1.438.419-2.186.043-.962.056-1.267.056-3.71s0-2.753-.056-3.71a6.581 6.581 0 0 0-.421-2.217zm-1.218 9.532a5.043 5.043 0 0 1-.311 1.688 2.987 2.987 0 0 1-1.712 1.711 4.985 4.985 0 0 1-1.67.311c-.95.044-1.218.055-3.654.055-2.438 0-2.687 0-3.655-.055a4.96 4.96 0 0 1-1.669-.311 2.985 2.985 0 0 1-1.719-1.711 5.08 5.08 0 0 1-.311-1.669c-.043-.95-.053-1.218-.053-3.654 0-2.437 0-2.686.053-3.655a5.038 5.038 0 0 1 .311-1.687c.305-.789.93-1.41 1.719-1.712a5.01 5.01 0 0 1 1.669-.311c.951-.043 1.218-.055 3.655-.055s2.687 0 3.654.055a4.96 4.96 0 0 1 1.67.311 2.991 2.991 0 0 1 1.712 1.712 5.08 5.08 0 0 1 .311 1.669c.043.951.054 1.218.054 3.655 0 2.436 0 2.698-.043 3.654h-.011z"></path>
                ...
                <Link
                  href="https://chat.whatsapp.com/IukSQXLUADIGrjgtQ3enq3"
                  target="_blank"
                  className="rounded-xl bg-white flex items-center text-blue justify-center hover:bg-primary hover:text-white duration-150 transition-all h-8 w-8"
                >
                  <svg
          ...
          <div className="flex md:justify-around justify-between w-full lg:w-[initial] flex-grow flex-wrap space-y-2 md:space-y-0">
            <div className="w-full md:max-w-max border-y-2 border-gray-500 py-2 md:py-0 md:border-y-0 space-y-2">
              <h5 className="flex justify-between items-center text-primary">
                ...
                <span className="text-3xl md:hidden">
                  <svg
                    ...
                    stroke-width="0"
                    viewBox="0 0 16 16"
                    className="duration-150 rotate-0"
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <div className="md:flex md:flex-col gap-2 md:h-full justify-evenly">
                ...
                <div className="inline-flex gap-1">
                  ...
                  <p>Bhagvatam className - 08:15 AM</p>
                </div>
                <div className="inline-flex gap-1">
                  <p className="pt-1">
                    <svg
                ...
                <div className="inline-flex gap-1">
                  ...
                  <p>Shayan Aarti - 8:30 PM </p>
                </div>
              </div>
            </div>
            <div className="w-full md:max-w-max border-b-2 border-gray-500 py-2 md:py-0 md:border-b-0 space-y-2">
              <h5 className="flex justify-between items-center text-primary">
              ...
              <div className="md:flex md:flex-col gap-2 md:h-full justify-evenly">
                ...
                <div className="inline-flex text-center gap-2">
                  ...
                  <p>Cultural Education Services</p>
                </div>
              </div>
            </div>
            <div className="w-full md:max-w-max border-b-2 border-gray-500 py-2 md:py-0 md:border-b-0 space-y-2">
              ...
              <div className="md:flex md:flex-col flex-grow justify-evenly md:h-full gap-2">
                ...
                <div className="md:flex flex-col flex-grow justify-between gap-2">
            ...
            <div className="flex md:hidden flex-col flex-grow justify-between gap-2 border-b-2 border-gray-500 space-y-2 py-2">
              <h5 className="flex justify-between items-center text-primary">
        ...
        <div className="max-w-7xl p-4 text-sm mx-auto flex flex-col justify-between pt-5 pb-10 border-t border-zinc-300 sm:flex-row gap-4 text-zinc-500">
          <p>
            ©{new Date().getFullYear()}{" "}
            <Link
              target="_blank"
              className="text-primary hover:underline"
              href="https://hkmjodhpur.org/"
            >
